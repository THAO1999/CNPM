    ...
    <div class="company-page">
        ...
        <div class="headers hidden-xs">
            ...
            <div class="headers__actions text-right">
                ...
                <a href="<?=Url::home() . 'organization-request/confirm?id=' . $organization_requests->id?>  "><button
                        class="btn btn-success  mb-4"> Chấp Nhận</button></a>
                <a href="<?=Url::home() . 'organization-request/create?id=' . $organization_requests->id?>  "><button
                        class="btn btn-danger "> Hủy</button></a>
                <?php elseif (OrganizationRequest::checkConfirm($organization_requests->status) == 10): ?>
                <a href="<?=Url::home() . 'student-registration/index?id=' . $organization_requests->id?>"> <button
                        class="btn btn-success mb-4 "> Danh Sách Đăng ki </button></a>
                <a href="<?=Url::home() . 'assigned-table/index?id=' . $organization_requests->id?>  "><button
                        class="btn btn-danger "> Danh Sách Phân Công</button></a>
            ...
            <div class="col-md-8 col-left">
                ...
                <ul class="navigation">
                    ...
                    <li class="text social-icon navigation__item navigation__item--right hidden-sm hidden-xs">
                        <a target="_blank" title="" rel="nofollow" data-controller="utils--tooltip"
                            href="https://www.facebook.com/homecreditvn" data-original-title="Đến Facebook"><i
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <h3 class="panel-title">Kĩ năng chúng tôi cần</h3>
                        <br>
                        <ul class="employer-skills">
                            <?php foreach ($lisSkill as $skill): ?>

                            <li class="employer-skills__item"><a data-controller="utm-tracking"
                                    href="#"><?=CapacityDictionary::getCapacity($skill)?></a></li>
                            <?php endforeach;?>
                        </ul>
                        <div class="paragraph">
                            <p></p>
                    ...
                    <div class="panel-body disable-user-select">
                        ...
                        <div class="review featured">
                            ...
                            <div class="sign-in-user-avatar"><img class="user-avatar"
                                    src="<?=Student::getImageStudent($comment->student->id)?>"></div>
                            <!-- kết thúc avatar -->
                            <a class="title a123" style='display: inline' href="#"><?=$comment->student->name?><br></a>
                            <div class="paragraph">
                                <?=$comment->content?>
                            </div>
                        </div>
