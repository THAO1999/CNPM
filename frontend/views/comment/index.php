...
<body class="reviews_new" data-controller="" data-env="production"
    data-jr-landing-new-url="https://itviec.com/jobrobot/new?locale=vi">
    <!-- Google Tag Manager -->
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h2 class="panel-title review-title hidden-xs hidden-sm">
                            <div class="title">
                                <div class="company-name" style="margin:17px"> <?=$enterprises->name?> </div>
                            </div>
                            <div class="logo">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="input hidden review_user_id"><input value="347739" class="hidden" type="hidden"
                                name="review[user_id]" id="review_user_id"></div>
