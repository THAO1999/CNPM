    ...
    <div class="company-page">
        ...
        <div class="cover-images-desktop cover-images-cropped aspect-ratio-box">
            <div class="aspect-ratio-box-inside">
                <img width="100%" alt="Home Credit Vietnam  tuyển dụng việc làm IT"
                    src="<?=Enterprises::getCoverImage($enterprise->id)?>">
            </div>
        </div>
        <!-- Header Information -->
            ...
            <div class="logo-container">
                <div class="has-overtime logo">
                    <img alt="Home Credit Vietnam  Vietnam Big Logo" class=" ls-is-cached lazyloaded"
                        ...
                        src="<?=Enterprises::getImageEnterprise($enterprise->id)?>">
                </div>
            </div>
        ...
        <div class="row company-container">
            <div class="col-md-8 col-left">
                ...
                <ul class="nav nav-tabs navigation">
                    <li class="active">
                        <a href="#detail_request" data-toggle="tab">
                            <h3>Chi tiết phiếu yêu cầu</h3>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#detail_profile" data-toggle="tab">
                ...
                <div class="panel panel-default ">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="paragraph">
                            <p></p>
                            <ul>
                                <li>Latest financial technology applied</li>
                                <li>Various bonuses and awards for employees</li>
                                <li>Professional and transparent working environment.</li>
                                <li>Health, social and accidental insurance</li>
                                <li>15 Annual Leaves</li>
                                <li>Team-building activities</li>
                                <li>Open sharing culture</li>
                            </ul>
                            <p></p>
                        </div>
                    </div>
                ...
                <div class="panel panel-default company-ratings">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="job-list">
                            ...
                            <div class="job">
                                <h2 class="name">
                                    <a data-controller="utm-tracking"
                                        href="<?=Url::home() . "detail-request-enterprise?id=" . $rq->id?>  "><?=$rq->subject?></a>
                                </h2>
                                <div class="salary">
                            ...
                            <hr>
                            <?php endforeach;?>
                            <a class="button ibutton full-width ibutton-red big add-review-when-not-sign-in"
                                rel="nofollow" href="<?=Url::home() . "comment/index?id=" . $rq->id?>  ">Viết review</a>
                        </div>
                    </div>
                </div>
            </div>
